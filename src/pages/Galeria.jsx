...
const images = [
  ...
  { url: 'https://images.unsplash.com/photo-1444392061186-9fc38f16d4ec?w=800&q=80', label: 'Vista aérea predio productor', cat: 'Predios' },
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Una muestra de nuestro trabajo en distintos predios, cultivos y regiones del país."
